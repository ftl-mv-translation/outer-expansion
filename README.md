# The Outer Expansion Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/outer-expansion/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest OE into src-en/ directory
