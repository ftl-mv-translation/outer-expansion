...
script.on_internal_event(Defines.InternalEvents.PRE_CREATE_CHOICEBOX, function(event)
	...
	if event.eventName == "AEA_JUSTICIER_BOOK_CREW" then
		...
		event:AddChoice(closeEvent, "Закрыть книгу.", emptyReq, true)
...
script.on_render_event(Defines.RenderEvents.CHOICE_BOX, function() end, function()
	...
	elseif commandGui.event_pause and renderRules then
		...
		Graphics.CSurface.GL_RenderPrimitiveWithColor(ritual, Graphics.GL_Color(1, 0, 0, 1))
		Graphics.freetype.easy_print(1, 11, -6, "Доступный ритуал.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Недоступный ритуал.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Ритуал требует присутствие вражеского корабля.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Ритуал требует определенного/отличающегося типа экипажа.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Ритуал требует определенных ресурсов.")
		Graphics.CSurface.GL_PopMatrix()
