...
spellListPage1[1] = {id = "heal_room", name="Prope Sana", hint_amount = 0, description="Sacrifiez une offrande de sang pour soigner ceux qui vous entourent.", condition="Aucune.", stat="50 PV de soins pendant 5 secondes pour les alliés dans la même pièce."}
spellListPage1[2] = {id = "heal_ship", name="Sana Navis", hint_amount = 1, description="Faites un grand sacrifice pour soigner ceux qui se trouvent sur le vaisseau.", condition="Aucune.", stat="150 PV de soins pendant 10 secondes pour les alliés se trouvant sur le même vaisseau."}
spellListPage1[3] = {id = "buff_damage", name="Damnum", hint_amount = 3, description="Accorde aux alliés un bonus de dégâts qui disparaît à la sortie de la zone.", condition="Aucune.", stat="Dégâts de combat ×1,5 jusqu’à la mort ou un saut, pour tous les alliés sur l’un ou l’autre des vaisseaux."}

spellListPage1[4] = {id = "buff_crew_health", name="Salus", hint_amount = 12, description="Confère de manière permanente à la cible une bénédiction de santé.", condition="Ne peut pas cibler des membres d’équipage temporaires, affaiblis ou déjà améliorés de manière similaire.", stat="Santé maximale ×1,5 de manière permanente pour le membre d’équipage ciblé."}
spellListPage1[5] = {id = "buff_crew_resistance", name="Resistentia", hint_amount = 12, description="Confère de manière permanente à la cible une bénédiction de résistance au vide et aux flammes.", condition="Ne peut pas cibler des membres d’équipage temporaires, affaiblis ou déjà améliorés de manière similaire..", stat="Immunité à la suffocation et au feu, et vitesse de soins ×2 pour le membre d’équipage ciblé."}
spellListPage1[6] = {id = "buff_crew_actions", name="Actio", hint_amount = 12, description="Confère de manière permanente à la cible une bénédiction de destruction et de restauration.", condition="Ne peut pas cibler des membres d’équipage temporaires, affaiblis ou déjà améliorés de manière similaire..", stat="Dégâts de combat ×1,5 et vitesse de réparation ×2 de manière permanente pour le membre d’équipage ciblé."}

spellListPage1[7] = {id = "teleport_one", name="Ianuae", hint_amount = 8, description="Téléporte la cible vers une destination éloignée.", condition="Doit être effectué sur le vaisseau du joueur..", stat="La cible est téléportée sur le navire ennemi."}
spellListPage1[8] = {id = "teleport_room", name="Ianuae Prope", hint_amount = 8, description="Téléporte la cible et ses alliés vers une destination lointaine.", condition="Doit être effectué sur le vaisseau du joueur.", stat="La cible et les alliés présents dans la même pièce sont téléportés sur le vaisseau ennemi."}
spellListPage1[9] = {id = "retrieve_crew", name="Recuperare", hint_amount = 8, description="Ramène des alliés situés à distance.", condition="Nécessite la présence d’équipage sur le vaisseau ennemi.", stat="Tout l’équipage à bord du navire ennemi est rapatrié."}

local spellListPage2 = {}
spellListPage2[1] = {id = "buy_fuel", name="Navis Cibum", hint_amount = 4, description="Offrir du sang et des richesses pour obtenir la faveur du voyage..", condition="Nécessite 10 ferrailles.", stat="Prend 10 ferrailles et rend 4-5 carburant."}
spellListPage2[2] = {id = "buy_missile", name="Tela", hint_amount = 4, description="Offrir du sang et des richesses pour obtenir la faveur des munitions.", condition="Nécessite 10 ferrailles.", stat="Prend 10 ferrailles et rend 2-3 missiles."}
spellListPage2[3] = {id = "buy_drone", name="Partes", hint_amount = 4, description="Offrir du sang et des richesses pour obtenir la faveur des composants.", condition="Nécessite 10 ferrailles.", stat="Prend 10 ferrailles et rend 2 pièces de drone."}

spellListPage2[4] = {id = "repair_system", name="Reparare Ratio", hint_amount = 6, description="Restaure les composants cassés grâce à un sacrifice de sang.", condition="La cible doit se trouver à l’intérieur d’une salle système.", stat="Répare 4 points de dégâts des systèmes."}
spellListPage2[5] = {id = "repair_hull", name="Reparare Navis", hint_amount = 6, description="Restaure le vaisseau grâce à un sacrifice de sang.", condition="Aucune.", stat="Répare 2 points de dégâts de coque."}

spellListPage2[6] = {id = "promote", name="Promovere", hint_amount = 20, description="Renforce de manière permanente la cible.", condition="Ne peut pas cibler les membres d’équipage temporaires, affaiblis ou sans voie de promotion.", stat="Améliore les membres d’équipage, par exemple : Humain -> Humain Soldat."}
spellListPage2[7] = {id = "give_weapon", name="Vocate Telum", hint_amount = 20, description="Exploite la technologie de la cible pour obtenir une arme.", condition="La cible doit être : Cristalien, Rocailleux, Orchidée, Vampiflore, Fantômes, Sangsue ou Obelisque.", stat="Accorde une arme correspondant au membre d’équipage ciblé."}

local spellListPage3 = {}
spellListPage3[1] = {id = "fire_bomb", name="Ignis", hint_amount = 18, description="Offrir du sang en sacrifice afin de déchaîner une pluie de feu sur vos ennemis.", condition="Nécessite 3 missiles et un vaisseau ennemi.", stat="Tire 3 bombes incendiaires sur le vaisseau ennemi."}
spellListPage3[2] = {id = "spawn_drone", name="Fucus", hint_amount = 16, description="Offrir du sang en sacrifice afin de déchaîner une attaque mécanique contre vos ennemis.", condition="Nécessite 3 Pièces de drones et un vaisseau ennemi.", stat="Invoque 3 drones laser autour du vaisseau ennemi."}
spellListPage3[3] = {id = "lockdown", name="Cincinno", hint_amount = 22, description="Offrir du sang en sacrifice et invoquez le pouvoir de la cible choisie afin de figer vos ennemis.", condition="La cible doit être un membre d’équipage Cristalien. La cible ne peut pas être affaiblie par un rituel.", stat="Tire 3 éclats Cristalien infligeant des dégâts et bloquant des salles du vaisseau ennemi."}
spellListPage3[4] = {id = "particle", name="Particula", hint_amount = 10, description="Offrir du sang en sacrifice afin de déchaîner la destruction sur vos ennemis.", condition="Nécessite un vaisseau ennemi.", stat="Tire 3 Lasers à particules sur le vaisseau ennemi."}
spellListPage3[5] = {id = "boarding", name="Conscensis", hint_amount = 16, description="Offrir du sang en sacrifice afin d’invoquer des guerriers mécaniques pour affronter vos ennemis.", condition="Nécessite 1 Pièce de drones, 1 missile et un vaisseau ennemi.", stat="Tire 3 drones d'abordage sur le vaisseau ennemi."}
...
local function createPage(id, name, description, hintAmount, event, condition, outcome, eventFix)
	...
	if Hyperspace.metaVariables["aea_dark_spell_"..id] > 0 then
		...
		if Hyperspace.metaVariables["aea_dark_spell_"..id] > 2 or Hyperspace.metaVariables["aea_dark_spell_all"] >= hintAmount + 5 then 
			eventString = eventString.."\nCondition du rituel : "..condition
		else
			eventString = eventString.."\nLes glyphes ici sont encore trop difficiles à déchiffrer, peut-être que de nouvelles expérimentations pourraient les révéler."
		end
		if Hyperspace.metaVariables["aea_dark_spell_"..id] > 4 then 
			eventString = eventString.."\nRésultat du rituel : "..outcome
		else
			eventString = eventString.."\nLes glyphes ici sont encore trop difficiles à déchiffrer, peut-être que de nouvelles expérimentations pourraient les révéler."
		end
	...
	elseif Hyperspace.metaVariables["aea_dark_spell_all"] >= hintAmount then
		local pageEvent = eventManager:CreateEvent("AEA_JUSTICIER_BOOK_TEMPLATE"..eventFix, 0, false)
		pageEvent.eventName = "AEA_JUSTICIER_BOOK_PAGE_"..id
		local eventString = "Les glyphes sur la page vous sont indéchiffrables, mais vous percevez de faibles signes rituels.\n\n\n\n\n\n\n\n\n"
		...
		pageEvent.text.data = eventString
		pageEvent.text.isLiteral = true
		event:AddChoice(pageEvent, "Une page avec de faibles marques rituelles.", blueReq, true)
	else
		local invalidEvent = eventManager:CreateEvent("OPTION_INVALID", 0, false)
		event:AddChoice(invalidEvent, "Les glyphes sont indéchiffrables. Peut-être qu’une utilisation plus fréquente des rituels vous en apprendra davantage.", emptyReq, true)
	end
end
...
script.on_internal_event(Defines.InternalEvents.PRE_CREATE_CHOICEBOX, function(event)
	...
	if event.eventName == "AEA_JUSTICIER_BOOK_CREW" then
		...
		event:AddChoice(closeEvent, "Fermer le livre.", emptyReq, true)
...
script.on_render_event(Defines.RenderEvents.CHOICE_BOX, function() end, function()
	...
	elseif commandGui.event_pause and renderRules then
		...
		Graphics.CSurface.GL_RenderPrimitiveWithColor(ritual, Graphics.GL_Color(1, 0, 0, 1))
		Graphics.freetype.easy_print(1, 11, -6, "Rituel valide.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Rituel invalide.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Rituel nécessitant la présence d’un vaisseau ennemi.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Rituel nécessitant un type d'équipage cible spécifique/différent.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Rituel nécessitant une type de pièce spécifique.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Rituel nécessitant une resource spécifique.")
		Graphics.CSurface.GL_PopMatrix()
		...
		Graphics.freetype.easy_print(1, 11, -6, "Le rituel doit être accompli pendant que vous avez un équipage à bord du vaisseau ennemi.")
		Graphics.CSurface.GL_PopMatrix()
